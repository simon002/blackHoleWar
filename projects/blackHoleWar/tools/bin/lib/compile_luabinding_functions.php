...
EOT;
    ...
    //fix bug of std::string length
    $find = 'tolua_pushcppstring(tolua_S,(const char*)tolua_ret);';
    $replace = 'if (tolua_ret.empty()) {lua_pushnil(tolua_S);} else lua_pushlstring(tolua_S, tolua_ret.c_str(), tolua_ret.size());';
    $rules[$find] = $replace;
...
class Builder
{
    ...
    function __construct($parameters)
    {
        ...
        $this->luaopenFunctionName_ = str_replace('-', '_', sprintf('luaopen_%s', basename($parameters['input_path'], '.tolua')));
